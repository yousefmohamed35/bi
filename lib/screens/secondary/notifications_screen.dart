...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Color _parseColor(dynamic colorValue, ColorScheme scheme) {
    if (colorValue == null) return scheme.primary;
  ...
  Widget _buildNotificationCard(
      ...
      {required bool isNew}) {
    final colorScheme = Theme.of(context).colorScheme;
    final color = _parseColor(notification['color']?.toString(), colorScheme);
  ...
  Widget _buildNotificationsSkeleton(BuildContext context) {
    final colorScheme = Theme.of(context).colorScheme;
    final skeletonBase = colorScheme.outlineVariant.withValues(alpha: 0.35);
    return Skeletonizer(
      enabled: true,
      child: SingleChildScrollView(
