      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ListTile(
              leading:
                  const Icon(Icons.camera_alt, color: AppColors.primaryMap),
            ...
            ListTile(
              leading:
                  const Icon(Icons.photo_library, color: AppColors.primaryMap),
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: label,
        prefixIcon: Icon(icon, color: AppColors.primaryMap),
        filled: true,
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(color: AppColors.primaryMap, width: 2),
        ),
