...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final iconChipColor =
        isDarkMode ? AppColors.whiteOverlay10 : AppColors.lavenderLight;
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildSettingItem(
                        icon: Icons.help,
                        label: AppLocalizations.of(context)!.helpAndContactUs,
                        onTap: () {
                          context.push(RouteNames.helpAndContact);
                        },
                      ),
            ...
            if (hasToggle)
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: toggleValue ? AppColors.primaryMap : surfaceColor,
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(
          l10n.selectLanguage,
          style:
              AppTextStyles.h4(color: Theme.of(context).colorScheme.onSurface),
        ),
        content: Column(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected ? AppColors.primaryMap : AppColors.border,
                  ...
                  children: [
                    ...
                    OutlinedButton.icon(
                      ...
                      style: OutlinedButton.styleFrom(
                        foregroundColor: AppColors.primaryMap,
                        side: const BorderSide(color: AppColors.primaryMap),
                      ),
                    ),
                  ],
                ),
