...
class _InstructorCourseDetailsScreenState
  ...
  Widget _buildStatusChip(Map<String, dynamic> course, {required bool isAr}) {
    ...
    switch (rawStatus) {
      ...
      default:
        label = rawStatus;
        color = AppColors.primaryMap;
        bg = AppColors.primaryMap.withOpacity(0.08);
    }
  ...
  Widget _buildTopCard({
    ...
    final imageUrl = thumbnail != null && thumbnail.isNotEmpty
        ...
        : null;
    String statusLabel = '';
    Color statusColor = AppColors.primaryMap;
    Color statusBg = AppColors.primaryMap.withOpacity(0.08);
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(icon, size: 18, color: AppColors.primaryMap),
              ),
              const SizedBox(width: 8),
              Text(
                title,
                          ...
                          child: Row(
                            children: [
                              Icon(
                                ...
                                size: 16,
                                color: AppColors.primaryMap.withOpacity(0.9),
                              ),
                              const SizedBox(width: 6),
                              Expanded(
                                child: Text(
                ...
                return Container(
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        radius: 18,
                        backgroundColor: AppColors.primaryMap.withOpacity(0.15),
                        backgroundImage:
                            ...
                            SizedBox(
                              ...
                              child: ClipRRect(
                                ...
                                child: LinearProgressIndicator(
                                  ...
                                  backgroundColor:
                                      AppColors.primaryMap.withOpacity(0.12),
                                  valueColor:
