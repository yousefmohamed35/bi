            ...
            child: Material(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Icon(e.$2, color: AppColors.primaryMap, size: 26),
      ...
      children: cards.map((e) {
        ...
        return Container(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(icon, color: AppColors.primaryMap, size: 26),
              const SizedBox(height: 6),
              Text(
                value >= 1000000
          ...
          if (hasCompletion) ...[
            ...
            Wrap(
              ...
              children: courseCompletion.map((e) {
                ...
                Color color = AppColors.primaryMap;
        ...
        children: [
          ...
          OutlinedButton.icon(
            ...
            style: OutlinedButton.styleFrom(
              ...
              side: BorderSide(color: AppColors.primaryMap.withOpacity(0.6)),
                            ...
                            Row(
                              children: [
                                Icon(Icons.category_rounded,
                                    size: 14, color: AppColors.primaryMap),
