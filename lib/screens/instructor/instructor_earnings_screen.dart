  ...
  Widget _buildEarningsByCourseCard(bool isAr) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: AppColors.primaryMap.withOpacity(0.08),
            blurRadius: 20,
            ...
            children: [
              Container(
                ...
                child: Icon(Icons.menu_book_rounded,
                    color: AppColors.primaryMap, size: 22),
              ),
              const SizedBox(width: 12),
              Text(
              ...
              return Expanded(
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        Icon(icon, color: AppColors.primaryMap, size: 24),
  ...
  Widget _buildCourseCompletionChart(List courseCompletion, bool isAr) {
    ...
    if (total <= 0) {
      return _buildChartCard(
        ...
        accentColor: AppColors.primaryMap,
        child: Center(
          child: Padding(
                  ...
                  LineChartBarData(
                    ...
                    belowBarData: BarAreaData(
                      ...
                      gradient: LinearGradient(
                        colors: [
                          AppColors.primaryMap.withOpacity(0.3),
                          AppColors.primaryMap.withOpacity(0.05),
                        ],
  ...
  Widget _buildSalaryBreakdownChart(bool isAr) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(AppRadius.card),
        border: Border.all(color: AppColors.primaryMap.withOpacity(0.08)),
        boxShadow: [
          BoxShadow(
            color: AppColors.primaryMap.withOpacity(0.08),
            blurRadius: 20,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            AppColors.primaryMap.withOpacity(0.04),
            AppColors.orange.withOpacity(0.03),
          ],
        ),
        borderRadius: BorderRadius.circular(AppRadius.card),
        border: Border.all(color: AppColors.primaryMap.withOpacity(0.12)),
        boxShadow: [
          BoxShadow(
            color: AppColors.primaryMap.withOpacity(0.06),
            blurRadius: 16,
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Icon(icon,
                size: 40, color: AppColors.primaryMap.withOpacity(0.7)),
          ),
          const SizedBox(height: 20),
          Text(
            title,
  ...
  Widget _buildAnalysisSummary(bool isAr) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(AppRadius.card),
        border: Border.all(color: AppColors.primaryMap.withOpacity(0.2)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            Colors.white,
            AppColors.primaryMap.withOpacity(0.02),
          ],
        ),
        borderRadius: BorderRadius.circular(AppRadius.card),
        border: Border.all(color: AppColors.primaryMap.withOpacity(0.2)),
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            AppColors.primaryMap.withOpacity(0.06),
                  ...
                  Row(
                    children: [
                      Icon(Icons.list_alt_rounded,
                          size: 20, color: AppColors.primaryMap),
              ...
              child: Row(
                children: [
                  Icon(Icons.description_outlined,
                      size: 18, color: AppColors.primaryMap),
                  const SizedBox(width: 10),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                ...
                child: Row(
                  children: [
                    Container(
                      padding: const EdgeInsets.all(12),
                      decoration: BoxDecoration(
                        color: AppColors.primaryMap.withOpacity(0.12),
                        borderRadius: BorderRadius.circular(16),
                      ),
                      child: Icon(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return Container(
                      ...
                      padding: const EdgeInsets.all(16),
                      decoration: BoxDecoration(
                        color: AppColors.primaryMap.withOpacity(0.04),
                        borderRadius: BorderRadius.circular(14),
                        border: Border.all(
                          color: AppColors.primaryMap.withOpacity(0.08),
                        ),
